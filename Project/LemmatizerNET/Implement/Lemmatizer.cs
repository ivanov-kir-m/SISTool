...
namespace LemmatizerNET.Implement {
	internal abstract class Lemmatizer : MorphDict, ILemmatizer {
		...
		private IParadigmCollection CreateParadigmCollectionInner(bool bNorm, string form, bool capital, bool usePrediction) {
			var res = new List<FormInfo>();
			CreateParadigmCollection(bNorm, form, capital, usePrediction, res);
